...
CONF_BASE_URL = "base_url"              # fixed base URL for webhook links
CONF_CONFIRM_OPEN = "confirm_open"      # require a tap to open (iOS refresh-safe)
